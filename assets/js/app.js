  ...
  const images = [
    {
      ...
      info:
        "A React game where the user has their memory tested! The user clicks an image, a" +
    ...
    },
    {
      ...
      info:
        "A Fullstack React application where the user can search the New York Times for a" +
    ...
    },
    {
      ...
      info:
        "A Full Stack app that scrapes the League of Legends page of reddit. The user also has the ability to save articles of interest to MongoDB. The user can also add comments on the articles that they save.",
      githubLink: "https://github.com/khoernlein90/webScrape",
      deployedLink: "https://enigmatic-peak-65650.herokuapp.com/",
      technologies: [
        "HTML, CSS, Express, Handlebars, Mongo, Mongoose, Axios, Cheerio"
      ]
    },
    {
    ...
    },
    {
      ...
      info:
        "A React app that takes the user input and automatically searches the Youtube API" +
        " whenever the user types.",
      githubLink: "https://github.com/khoernlein90/react-youtube",
      deployedLink: "https://khoernlein90.github.io/react-youtube/",
    ...
    },
    {
      ...
      info:
        "A web app which uses the Giphy API to search for movie GIFs (or any GIF for that" +
    ...
    },
    {
      ...
      info:
        "A basic Hangman game where the user will have 10 guesses to try and figure out t" +
    ...
    },
    {
      ...
      info:
        "A fun browser game where the user has to try and make their score match the rand" +
        "om number! ",
    ...
    },
    {
      ...
      info:
        "A web app where the user can schedule mock trains. The trains are timed and stor" +
